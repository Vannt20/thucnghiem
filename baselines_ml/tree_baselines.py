...
class RandomForestBaseline:
    """
    Random Forest Regressor theo chiến lược multi_output: shared_model:
    - 1 model duy nhất cho toàn bộ N luồng OD.
    - Khống chế max_depth=12 và min_samples_leaf=5 để tránh tràn RAM trên hàng triệu dòng dữ liệu.
    """
